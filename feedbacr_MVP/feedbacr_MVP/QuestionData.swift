...
var questions: [Question] = [
    ...
    Question(questionText: "How was the demeanor/attitude of the interviewee during the interview?", type: .multipleChoice, responseAnswers: [ResponseAnswers(answerText: "The interviewee was confident."), ResponseAnswers(answerText: "The interviewee seemed nervous."), ResponseAnswers(answerText: "The interviewee was distracted during the interview.")]),
    Question(questionText: "How well did the interviewee maintain eye contact?", type: .multipleChoice, responseAnswers: [ResponseAnswers(answerText: "1 - Very little eye contact was made."), ResponseAnswers(answerText: "2"), ResponseAnswers(answerText: "3"), ResponseAnswers(answerText: "4"), ResponseAnswers(answerText: "5 - The interveiwee maintain eye contact during the whole interview.")]),
